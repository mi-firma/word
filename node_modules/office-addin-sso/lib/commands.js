        ...
        if (Object.keys(userJson).length >= 1) {
            ...
            if (applicationJson) {
                ...
                if (yield configure.isUserTenantAdmin(userJson)) {
                    ...
                    yield configure.grantAdminContent(applicationJson);
                ...
                ssoDataSettings_1.addSecretToCredentialStore(manifestInfo.displayName, secret);
            }
            else {
            ...
            const projectUpdated = yield ssoDataSettings_1.writeApplicationData(applicationJson['appId'], port.toString(), manifestPath);
            if (!projectUpdated) {
            ...
            // Send usage data
            defaults_1.usageDataObject.reportSuccess('configureSSO', { configDuration: ssoConfigDuration });
        }
        else {
