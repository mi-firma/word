...
exports.setOutlookTenantReplyUrl = exports.setSharePointTenantReplyUrls = exports.setSignInAudience = exports.setIdentifierUri = exports.setApplicationSecret = exports.logoutAzure = exports.logIntoAzure = exports.isUserTenantAdmin = exports.installAzureCli = exports.isAzureCliInstalled = exports.grantAdminContent = exports.createNewApplication = void 0;
/*
...
function createNewApplication(ssoAppName, port, userJson) {
...
function applicationReady(applicationJson) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function grantAdminContent(applicationJson) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            while (appReady === false && counter <= 50) {
                appReady = yield applicationReady(applicationJson);
                counter++;
            }
            if (counter > 50) {
                const warningMessage = 'Application does not appear to be ready to grant admin consent';
                return;
            }
            ...
            const errorMessage = `Unable to set grant admin consent: \n${err}`;
            throw new Error(errorMessage);
        }
    });
}
exports.grantAdminContent = grantAdminContent;
        ...
        try {
            ...
            switch (process.platform) {
                case "win32":
                    ...
                    // Send usage data
                    defaults_1.usageDataObject.reportSuccess('isAzureCliInstalled()', { cliInstalled: cliInstalled });
                    return cliInstalled;
                case "darwin":
...
function isUserTenantAdmin(userInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.reportSuccess('isUserTenantAdmin()', { isUserTenantAdmin: isTenantAdmin });
...
function setIdentifierUri(applicationJson, port) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const errorMessage = `Unable to set identifierUri: \n${err}`;
            throw new Error(errorMessage);
        }
    });
}
...
function setSignInAudience(applicationJson) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const errorMessage = `Unable to set signInAudience: \n${err}`;
            throw new Error(errorMessage);
        }
    });
}
...
function setSharePointTenantReplyUrls(tenantName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.reportSuccess('setTenantReplyUrls()', { isUserTenantAdmin: setReplyUrls });
            return setReplyUrls;
        }
        catch (err) {
...
function setOutlookTenantReplyUrl() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.reportSuccess('setOutlookTenantReplyUrls()', { tenantReplyUrlsSet: setReplyUrls });
            return setReplyUrls;
        }
        catch (err) {
            const errorMessage = `Unable to set tenant reply urls. \n${err}`;
