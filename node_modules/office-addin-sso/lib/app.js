...
class App {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authRouter = new authRoute_1.AuthRouter();
            ...
            // listen for 'ping'
            this.appInstance.get("/ping", function (req, res, next) {
            ...
            this.appInstance.get('/getuserdata', function (req, res, next) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const graphData = yield msgraph_helper_1.getGraphData(graphToken, graphUrlSegment, graphQueryParamSegment);
