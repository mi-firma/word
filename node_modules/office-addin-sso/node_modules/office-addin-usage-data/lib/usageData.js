    ...
    reportException(method, err, data = {}) {
        if (this.getUsageDataLevel() === UsageDataLevel.on) {
            try {
                ...
                Object.entries(Object.assign(Object.assign({ Succeeded: false, Method: method, ExpectedError: false }, this.defaultData), data)).forEach((entry) => {
    ...
    sendUsageDataEvent(data = {}) {
        if (this.getUsageDataLevel() === UsageDataLevel.on) {
            try {
                ...
                eventTelemetryObj.properties = Object.assign(Object.assign({}, this.defaultData), data);
